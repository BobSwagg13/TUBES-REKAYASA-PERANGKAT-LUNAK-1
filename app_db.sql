-- MariaDB dump 10.19-11.0.5-MariaDB, for Win64 (AMD64)
--
-- Host: localhost    Database: app_db
-- ------------------------------------------------------
-- Server version	11.0.5-MariaDB
...
CREATE TABLE `latihan` (
  ...
  `alat` varchar(30) DEFAULT NULL,
  `deskripsi` varchar(255) NOT NULL,
  PRIMARY KEY (`id_latihan`),
  UNIQUE KEY `nama_latihan` (`nama_latihan`)
...
INSERT INTO `latihan` VALUES
(1,'Pushup',NULL,'Pushup sederhana dengan tangan lurus');
...
-- Dump completed on 2024-12-09  6:08:00
